...
PLANE DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE
{
  lineno++;
  op[lastop].opcode = PLANE;
  op[lastop].op.plane.d[0] = $2;
  op[lastop].op.plane.d[1] = $3;
  op[lastop].op.plane.d[2] = $4;
  op[lastop].op.plane.d[3] = 0;
  op[lastop].op.plane.w = $5;
  op[lastop].op.plane.h = $6;
  op[lastop].op.plane.constants = NULL;
  op[lastop].op.plane.cs = NULL;

  lastop++;
}|
PLANE DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE STRING
{
  lineno++;
  op[lastop].opcode = PLANE;
  op[lastop].op.plane.d[0] = $2;
  ...
  op[lastop].op.plane.constants = NULL;
  m = (struct matrix *)new_matrix(4,4);
  op[lastop].op.plane.cs = add_symbol($7,SYM_MATRIX,m);
  lastop++;
}|
PLANE STRING DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE
{
  lineno++;
  op[lastop].opcode = PLANE;
  op[lastop].op.plane.d[0] = $3;
  op[lastop].op.plane.d[1] = $4;
  op[lastop].op.plane.d[2] = $5;
  op[lastop].op.plane.d[3] = 0;
  op[lastop].op.plane.w = $6;
  op[lastop].op.plane.h = $7;
  op[lastop].op.plane.cs = NULL;
  c = (struct constants *)malloc(sizeof(struct constants));
  op[lastop].op.plane.constants = add_symbol($2,SYM_CONSTANTS,c);

  lastop++;
}|
PLANE STRING DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE STRING
{
  lineno++;
  op[lastop].opcode = PLANE;
  op[lastop].op.plane.d[0] = $3;
  ...
  op[lastop].op.plane.constants = add_symbol($2,SYM_CONSTANTS,c);
  m = (struct matrix *)new_matrix(4,4);
  op[lastop].op.plane.cs = add_symbol($8,SYM_MATRIX,m);
